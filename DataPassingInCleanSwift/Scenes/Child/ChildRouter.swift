...
class ChildRouter: NSObject, ChildRoutingLogic, ChildDataPassing
{
    ...
    //func navigateToSomewhere(source: ChildViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: ChildDataStore, destination: inout SomewhereDataStore)
    //{
